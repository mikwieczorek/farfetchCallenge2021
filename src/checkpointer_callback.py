...
class ModelCheckpointPeriodic(Callback):
    ...
    def __init__(
        self, dirname, filename_prefix, save_interval=None, n_saved=1, create_dir=True
    ):
    ...
    def on_epoch_end(self, trainer, pl_module):
        ...
        ), f"Periodic model checkpointer should only save from process number 0! Got: {trainer.global_rank}"
